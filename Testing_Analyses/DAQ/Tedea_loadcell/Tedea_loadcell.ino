...
float loadA = 2.828; // kg
int analogvalA = 200; // analog reading taken with load A on the load cell

float loadB = 4.661; // kg 
int analogvalB = 330; // analog reading taken with load B on the load cell
...
long time = 0; // 
int timeBetweenReadings = 1000; // We want a reading every 200 ms;
